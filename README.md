About pyemma_tutorials-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyemma_tutorials-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/markovmodel/pyemma_tutorials

Documentation: https://github.com/markovmodel/pyemma_tutorials
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5978&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyemma_tutorials-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyemma_tutorials` can be installed with `conda`:
...
```
mamba install pyemma_tutorials
```

It is possible to list all of the versions of `pyemma_tutorials` available on your platform with `conda`:
...
```
mamba search pyemma_tutorials --channel conda-forge
```
...
mamba repoquery search pyemma_tutorials --channel conda-forge

# List packages depending on `pyemma_tutorials`:
mamba repoquery whoneeds pyemma_tutorials --channel conda-forge

# List dependencies of `pyemma_tutorials`:
mamba repoquery depends pyemma_tutorials --channel conda-forge
```
